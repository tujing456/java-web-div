...
<div class="explore">
    ...
    <label>
        <input type="text" placeholder="搜索你感兴趣的电影" class="search-input">
    </label>
</div>
<br>
    ...
    <div class="row">
        ...
        <div class="col-8">
            ...
            <div class="item">
                ...
                <p>终于可有属于自己的相册来放照片拉，好开心。一定要放美美的照片。</p>
            </div>
            <div class="item">
                <ul class="nav">
                    <li>我读</li>
            ...
            <div class="item">
                ...
                <div class="read">
                    <p><a href="">${user.nickname}</a>想读
                        <a href="">我和我的祖国电影出来拉 ，大家一定要去看呀。</a>
                    </p>
                    <p style="color: #9b9b9b;">2018年1月2日</p>
                </div>
                <div class="read">
                    <p><a href="">${user.nickname}</a>想读
                        <a href="">最近新出的攀登者电影不错，强烈推荐小伙伴去看看。</a>
                    </p>
                    <p style="color: #9b9b9b;">2018年1月2日</p>
                </div>
                <div class="read">
                    <p><a href="">${user.nickname}</a>想读
                        <a href="">不知道大家有没有去看中国机长呀 ，听说很感人的呦！</a>
                    </p>
                    <p style="color: #9b9b9b;">2018年1月2日</p>
                </div>
            </div>
